...
Last anyone heard, he was visiting locations that are historically significant to the North Pole; a group of Senior Historians has asked you to accompany 
...
In the example above, this is 2 + 1 + 0 + 1 + 2 + 5, a total 
distance of 11!
...
with open("day1_input.txt","r", encoding="utf-8") as file:
      for line in file:
            ...
            listL.append(int(cur[0]))
            listR.append(int(cur[1]))
...
for i in range(len(listL)):
      ...
      totalDiff += abs(listL[i] - listR[i])

print(f"The total difference is: {totalDiff}")

#Part2
similarityScore = 0
count = {num:0 for num in listL}
